        ...
        if (currentSession?.user) {
            ...
            if (freshProfile) {
                if (freshProfile.account_type === 'personal') {
                    ...
                    // Sem tipo de conta definido -> Escolha obrigatória
